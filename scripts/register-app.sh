...
TEMP_FILE=$(mktemp)
# All GUIDs verified against live Microsoft Graph service principal via:
#   az ad sp show --id 00000003-0000-0000-c000-000000000000 --query "appRoles[?value=='<perm>'].id"
